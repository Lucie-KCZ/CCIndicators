...
indicators <- indicators[indicators$Global_set, ]
...
write.csv(results, paste0("./GlobalSet/", format(Sys.time(), "%Y%m"), "_GlobalSet_sources.csv"), row.names = FALSE)
